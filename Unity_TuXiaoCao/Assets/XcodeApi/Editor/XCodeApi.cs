...
namespace yoyohan
{
    ...
    public class XCodeApi
    {
        ...
        public static void OnPostProcessBuild(BuildTarget buildTarget, string pathToBuiltProject)
        {
            ...
            //增加http支持 Unity2018.4.3的PlayerSetting已经可以配置该选项
            //PlistElementDict nsDic = new PlistElementDict();
            //nsDic.SetBoolean("NSAllowsArbitraryLoads", true);
            //rootDict.values.Add(new KeyValuePair<string, PlistElement>("NSAppTransportSecurity", nsDic));
            #endregion
